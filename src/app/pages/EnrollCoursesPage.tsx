        ...
        <>
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            {filtered.map(course => {
              ...
              return (
                <div key={course.id} className="bg-white rounded-xl border-2 border-blue-300 p-4">
                  <div className="flex items-center gap-2 mb-2">
                    <span className="text-xs font-mono bg-gray-100 text-gray-600 px-2 py-0.5 rounded">{course.code}</span>
                    <span className="text-xs bg-blue-50 text-blue-600 px-2 py-0.5 rounded">Year {course.year}</span>
                    <span className="text-xs bg-blue-100 text-blue-700 px-2 py-0.5 rounded font-medium">Enrolled</span>
                  </div>
